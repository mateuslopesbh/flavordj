	...
	function ativa_facebook(){
	   ...
	   console.log(response);
	    ...
	    $.post('getUser.php', { facebookId: response.id}, function(data){
		    ...
		    if(data.success){
	   			alert('Você já tem uma batida compartilhada. Por que não convida seus amigos para dar aquela votada?');
		        ...
		        $.post('salva_som.php', { 
					...
					if(data.success){
						...
						FB.api('/me/feed', 'post', { link: 'https://apps.facebook.com/flavordj/?batidas=flavordj&minhaBatida='+data.batida, picture: 'https://lit-castle-9930.herokuapp.com/img/share/flavor'+image+'.jpg' }, function(response) {
